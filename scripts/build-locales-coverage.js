...
const files = readdirSync(`${__dirname}/../packages/excalimove/locales`);
...
for (let index = 0; index < locales.length; index++) {
  ...
  const data = flatten(
    require(`${__dirname}/../packages/excalimove/locales/${currentLocale}`),
  );
...
writeFileSync(
  `${__dirname}/../packages/excalimove/locales/percentages.json`,
