...
```bash
npm install @excalimove/utils
```

If you prefer Yarn over npm, use this command to install the Excalidraw utils package:

```bash
bun add @excalimove/utils
```
...
See [`serializeAsJSON`](https://github.com/excalidraw/excalidraw/blob/master/src/packages/excalimove/README.md#serializeAsJSON) for API and description.
...
```js
import { exportToSvg, exportToBlob } from "@excalimove/utils";
```

To use it in a browser directly:

```html
<script src="https://unpkg.com/@excalimove/utils@0.1.0/dist/excalidraw-utils.min.js"></script>
<script>
