...
import * as mockedSceneExportUtils from "@excalimove/excalimove/scene/export";
import { diagramFactory } from "@excalimove/excalimove/tests/fixtures/diagramFixture";
