...
import type { ArrowEndpoint } from "@excalimove/element";
import type { GlobalPoint, LocalPoint, Radians } from "@excalimove/math";
...
class App extends React.Component<AppProps, AppState> {
  ...
  public updateScene = withBatchedUpdates(
    <K extends keyof AppState>(sceneData: {
       ...
       *
       * Check [API docs](https://docs.excalidraw.com/docs/@excalimove/excalimove/api/props/excalidraw-api#captureUpdate) for more details.
       *
