...
import { TOOL_TYPE, KEYS } from "@excalimove/common";
import {
  getCommonBounds,
  getDraggedElementsBounds,
  getElementAbsoluteCoords,
} from "@excalimove/element";
import { isBoundToContainer } from "@excalimove/element";

import { getMaximumGroups } from "@excalimove/element";
...
import type { InclusiveRange } from "@excalimove/math";

import type { Bounds } from "@excalimove/common";
import type { MaybeTransformHandleType } from "@excalimove/element";
import type {
  ElementsMap,
  ExcalidrawElement,
