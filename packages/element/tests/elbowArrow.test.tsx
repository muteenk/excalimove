import { ARROW_TYPE } from "@excalimove/common";
import { pointFrom } from "@excalimove/math";
import { Excalidraw } from "@excalimove/excalimove";
import { actionSelectAll } from "@excalimove/excalimove/actions";
import { actionDuplicateSelection } from "@excalimove/excalimove/actions/actionDuplicateSelection";
import { API } from "@excalimove/excalimove/tests/helpers/api";
import { Pointer, UI } from "@excalimove/excalimove/tests/helpers/ui";
import {
  act,
  fireEvent,
  GlobalTestState,
  queryByTestId,
  render,
} from "@excalimove/excalimove/tests/test-utils";
import "@excalimove/utils/test-utils";
import { bindBindingElement } from "@excalimove/element";

import { Scene } from "../src/Scene";

import type { LocalPoint } from "@excalimove/math";
