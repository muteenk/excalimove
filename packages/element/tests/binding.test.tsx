import { KEYS, arrayToMap } from "@excalimove/common";

import { pointFrom } from "@excalimove/math";

import { actionWrapTextInContainer } from "@excalimove/excalimove/actions/actionBoundText";

import { Excalidraw, isLinearElement } from "@excalimove/excalimove";

import { API } from "@excalimove/excalimove/tests/helpers/api";
import { UI, Pointer, Keyboard } from "@excalimove/excalimove/tests/helpers/ui";
import {
  act,
  fireEvent,
  render,
...
import { defaultLang, setLanguage } from "@excalimove/excalimove/i18n";
...
} from "../../excalimove/tests/queries/dom";
