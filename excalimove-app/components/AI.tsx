...
import { getDataURL } from "@excalimove/excalimove/data/blob";
import { safelyParseJSON } from "@excalimove/common";
            ...
            if (errorJSON.statusCode === 429) {
              return {
                ...
                <div style="display: flex; align-items: center; justify-content: center; flex-direction: column; height: 100vh; padding: 0 60px">
                  <div>Too many requests today,</br>please try again tomorrow!</div>
                </div>
                </body>
                </html>`,
              };
