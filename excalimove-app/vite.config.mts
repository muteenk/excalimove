  ...
  return {
    ...
    build: {
      ...
      rollupOptions: {
        output: {
          ...
          manualChunks(id) {
            if (
              id.includes("packages/excalimove/locales") &&
    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          short_name: "Excalimove",
          name: "Excalimove",
          description: "Excalimove is a whiteboard with keyframe timeline animation for canvas elements.",
          icons: [
            {
