...
import {
  createRedoAction,
  createUndoAction,
} from "@excalimove/excalimove/actions/actionHistory";
import { syncInvalidIndices } from "@excalimove/element";
import { API } from "@excalimove/excalimove/tests/helpers/api";
import { act, render, waitFor } from "@excalimove/excalimove/tests/test-utils";
import { vi } from "vitest";

import { StoreIncrement } from "@excalimove/element";

import ExcalidrawApp from "../App";

import type { DurableIncrement, EphemeralIncrement } from "@excalimove/element";
...
vi.mock("../../excalimove-app/data/firebase.ts", () => {
