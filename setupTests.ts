...
import polyfill from "./packages/excalimove/polyfill";
import { mockThrottleRAF } from "./packages/excalimove/tests/helpers/mocks";
import { yellow } from "./packages/excalimove/tests/helpers/colorize";
import {
  PolyfillLocalStorage,
  testPolyfills,
} from "./packages/excalimove/tests/helpers/polyfills";
...
vi.mock("@excalimove/common", async (importOriginal) => {
  const module = await importOriginal<typeof import("@excalimove/common")>();
...
vi.mock(
  "./packages/excalimove/fonts/ExcalidrawFontFace",
  async (importOriginal) => {
    const mod = await importOriginal<
      typeof import("./packages/excalimove/fonts/ExcalidrawFontFace")
    >();
